...
type Coin struct {
	...
	Initialprice string             `json:"initialprice,omitempty" bson:"initialprice,omitempty" validate:"required"`
	High         string             `json:"high,omitempty" bson:"high,omitempty" validate:"required"`
	Low          string             `json:"low,omitempty" bson:"low,omitempty" validate:"required"`
/*
